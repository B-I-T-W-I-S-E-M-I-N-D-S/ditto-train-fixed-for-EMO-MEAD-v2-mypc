...
def gather_and_filter_data_list_for_s2_v2(
    ...
    """
    frame_num, mtn, aud, emo, eye_open, eye_ball, emo2vec
    LP_npy_list, hubert_aud_npy_list, emo_npy_list, eye_open_npy_list, eye_ball_npy_list, emo2vec_npy_list
    ...
    for i in trange(num_v):
        try:
            ...
            if use_emo2vec:
                data['emo2vec'] = data_list_dict['emo2vec_npy_list'][i]
...
class Options:
    ...
    use_emo2vec: bool = False    # use Emotion2vec audio emotion features (MEMO-style)
